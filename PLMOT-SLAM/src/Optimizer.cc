...
//    cout<<"Track RefereceKF 51 "<<endl;
    ...
    {
    unique_lock<mutex> lock(MapPoint::mGlobalMutex);
//    cout<<"Track RefereceKF 52 "<<endl;
    for(int i=0; i<N; i++)
    {
//        cout<<"MpPoints 00 "<<endl;
        MapPoint* pMP = pFrame->mvpMapPoints[i];
        if(pMP)
        {
            // Monocular observation
...
//    cout<<"Track RefereceKF 531 "<<endl;
    for(int i=0; i<N_l; i++)
    {
//        cout<<"Track RefereceKF 532 "<<endl;
...
//            cout<<"Track RefereceKF 533 "<<endl;
            ORB_SLAM3::EdgeLineSE3ProjectXYZOnlyPose* e = new ORB_SLAM3::EdgeLineSE3ProjectXYZOnlyPose();

            e->setVertex(0, dynamic_cast<g2o::OptimizableGraph::Vertex*>(optimizer.vertex(0)));
            e->setMeasurement(obs);
            const float invSigma2 = pFrame->mvInvLevelSigma2_l[pFrame->mvKeys_Line[i].octave];
            e->setInformation(Eigen::Matrix2d::Identity()*Weight*invSigma2);

//            cout<<"Track RefereceKF 534 "<<endl;
            g2o::RobustKernelHuber* rk = new g2o::RobustKernelHuber;
            e->setRobustKernel(rk);
...
//            cout<<"Track RefereceKF 535 "<<endl;
            optimizer.addEdge(e);
//            cout<<"Track RefereceKF 536 "<<endl;
